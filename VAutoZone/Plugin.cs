...
namespace VAuto.Zone
{
 ...
 a                BindConfiguration();
                ...
                // Initialize arena territory first
                try
                {
                ...
                try
                {
                    ...
                    if (serverWorld != null)
                    {
                        ...
                        _zoneEventBridge = new ZoneEventBridge(Logger, entityManager);
                        _zoneEventBridge.Start();
                        Logger.LogInfo("ZoneEventBridge started");
                    }
                    else
                    {
                        Logger.LogWarning("ZoneEventBridge not started - ServerWorld not available");
                    }
                }
                catch (Exception ex)
                {
