...
function App() {
  ...
  return <BrowserContainer className="app-container">
      {/* Header */}
      <header style={{
      padding: '16px 24px',
      ...
      justifyContent: 'space-between'
    }} data-test="auto-App-header-001">
        <h1 style={{
        fontSize: '20px',
        fontWeight: 600,
        color: '#ffffff'
      }} data-test="auto-App-h1-002">
        ...
        gap: '12px',
        alignItems: 'center'
      }} data-test="auto-App-div-003">
          <input type="text" placeholder="Server URL" value={serverUrl} onChange={e => setServerUrl(e.target.value)} style={{
          background: '#383c4a',
          ...
          color: '#8c91a0',
          width: '200px'
        }} data-test="auto-App-input-004" />
          <input type="password" placeholder="API Key" value={apiKey} onChange={e => setApiKey(e.target.value)} style={{
          background: '#383c4a',
          border: '1px solid rgba(0,0,0,0.5)',
          borderRadius: '4px',
          padding: '6px 12px',
