...

{
...

    {
        ...
        public StatExtensionService(ProjectM.Scripting.ServerGameManager? serverGameManager, EntityManager entityManager)
...

        {
...

            {
                ...
                return _serverGameManager.TryGiveItem(player, buffGuid, 1);
...

            {
                ...
                Plugin.Log.LogWarning($"[StatExtensionService] Failed to apply buff {buffGuid.GuidHash}: {ex.Message}");
