...
namespace VAuto.EndGameKit.Helpers
{
    ...
    public static class PlayerHelper
    {
        ...
        {
            if (!em.HasComponent<User>(player))
                return 0;

            return em.GetComponentData<User>(player).PlatformId;
        }
        ...
        {
            // A player is considered online if they exist and have a User
            return em.Exists(player) && em.HasComponent<User>(player);
        }
