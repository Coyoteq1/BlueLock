...
namespace VAuto.Extensions
{
    ...
    public static class VAutoExtensions
    {
        ...
        {
            return VAutoCore.EntityManager.CreateEntityQuery(typeof(T));
        }
        ...
        {
            var query = VAutoCore.EntityManager.CreateEntityQuery(typeof(T));
        ...
        {
            return Prefabs.GetPrefabGuid(guid.Value.ToString()) != null;
        }
